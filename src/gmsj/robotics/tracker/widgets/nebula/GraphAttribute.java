...
public class GraphAttribute implements ITreeElement , ISelectedPreferenceTarget , IAttributeListener {
	...
	GraphAttribute () {
		...
		traceProvider.setBufferSize  ( 10000000 ) ;
	...
	void init ( GraphFigure xyGraphFigure , WidgetAttribute targetAttribute, IEclipseContext parentContext, 
		...
		trace 				= new Trace ( attribute.getName () , 
				...
				traceProvider ) ;
//		trace.getXAxis().setTimeUnit(Calendar.MILLISECOND);
//		trace.getXAxis().setDateEnabled ( true ) ;
...
//				if ( ++nbSample > 50000 ) {
//					traceProvider.setClippingWindow ( 10000 ) ; 
//				}
			}
//			else {
//				// TODO XY
...
//			}		
			...
			System.out.println ( "GraphAttribute::attributeChanged: invalid value: " + event.getValue() ) ;
		}
		}
	}
